...
struct FileGenerator {
    ...
    static func stringFor(filename: String) throws -> String {
        ...
        case "SwiftyJSONMapperTemplate":
            return "  // MARK: Moya-SwiftyJSONMapper Initializers\n  /// Initiates the instance based on the object.\n  ///\n  /// - parameter object: The object of either Dictionary or Array kind that was passed.\n  /// - returns: An initialized instance of the class.\n  public convenience init(object: Any) {\n    self.init(jsonData: JSON(object))\n  }\n\n  /// Initiates the instance based on the JSON that was passed.\n  ///\n  /// - parameter jsonData: JSON object from SwiftyJSON.\n  public{REQUIRED}init(jsonData: JSON) {\n{INITIALIZER}\n  }\n"
        case "BaseTemplate":
